...
is
   ...
   is begin
    adauga_pacient('Grigore', 'Maria', 'FEMEIE', '0752 139 333', 'GM@test.com', 16, 117, 'f', 18, 21, to_date('22-11-1971', 'DD-MM-YYYY'));
    adauga_pacient('Grigore', 'Nelu', 'BARBAT', '0712 139 333', 'GN@test.com', 16, 115, 'f', 18, 21, to_date('23-08-1971', 'DD-MM-YYYY'));
    adauga_pacient('Grigore', 'Diana', 'FEMEIE', '0752 129 333', 'GD@test.com', 16, 116, 'r', 18, 21, to_date('12-01-2000', 'DD-MM-YYYY'));
    adauga_pacient('Apostoiu', 'Lucia', 'FEMEIE', '0752 133 333', 'AL@test.com', 17, 117, 'f', 18, 21, to_date('22-10-1971', 'DD-MM-YYYY'));
    adauga_pacient('Apostoiu', 'Bogdan', 'BARBAT', '0752 239 333', 'AB@test.com', 17, 118, 'r', 18, 21, to_date('22-11-1987', 'DD-MM-YYYY'));
...
insert into medic_familie values(medic_seq.nextval, 'Ghetea', 'Marinela', 0, '0755 125 125');